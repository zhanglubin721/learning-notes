...
![image-20250424174349121](image/image-20250424174349121.png)
...
![image-20250424220639367](image/image-20250424220639367.png)
...
其中 SpinPause() 是一个宏，会执行若干次 PAUSE 指令（x86 架构下）或 yield。
