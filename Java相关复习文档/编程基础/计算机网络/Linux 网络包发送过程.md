...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153509039.png)

虽然数据这时已经发送完毕，但是其实还有一件重要的事情没有做，那就是释放缓存队列等内存。

那内核是如何知道什么时候才能释放内存的呢，当然是等网络发送完毕之后。网卡在发送完毕的时候，会给 CPU 发送一个硬中断来通知 CPU。更完整的流程看图：

![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153518875.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153523495.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153548467.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153552229.png)

其中代表一条连接的 socket 内核对象更为具体一点的结构图如下。

![25 张图，一万字，拆解 Linux 网络包发送过程](https://img.ithome.com/newsuploadfiles/2022/9/a8ffe432-41ed-415e-86f7-bec0dff0be84.png?x-bce-process=image/format,f_auto)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153557306.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153608174.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153623285.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153635821.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153642561.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153652990.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153701054.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153707558.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153712905.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153735530.png)

在邻居子系统里主要是查找或者创建邻居项，在创造邻居项的时候，有可能会发出实际的 arp 请求。然后封装一下 MAC 头，将发送过程再传递到更下层的网络设备子系统。大致流程如图。

![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153738348.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153753301.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153819842.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153835219.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153850613.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930153859604.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930164109023.png)
...
![25 张图，一万字，拆解 Linux 网络包发送过程](image/format,f_auto-20220930164112846.png)
